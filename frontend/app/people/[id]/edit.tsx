...
import { usePerson, useUpdatePerson } from '@/src/api/people';
...
export default function EditPersonScreen() {
  ...
  const mutation = useUpdatePerson(Number(id));
  ...
  const handleSave = () => {
    ...
    mutation.mutate(
      ...
      },
      {
        ...
        onError: () => Alert.alert('Error', 'Failed to update character.'),
      }
    );
  };
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Field label="Birth Year" value={birthYear} onChangeText={setBirthYear} />
      <Field label="Height (cm)" value={height} onChangeText={setHeight} />
      <Field label="Mass (kg)" value={mass} onChangeText={setMass} />
